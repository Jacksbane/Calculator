...
Main::Main() : wxFrame(nullptr, wxID_ANY, "Calculator")
{
	...
	one = new wxButton(this, wxID_ANY, "1", wxPoint(10, 60), wxSize(60, 40));
	two = new wxButton(this, wxID_ANY, "2", wxPoint(70, 60), wxSize(60, 40));
	three = new wxButton(this, wxID_ANY, "3", wxPoint(130, 60), wxSize(60, 40));
	...
	seven = new wxButton(this, wxID_ANY, "7", wxPoint(10, 140), wxSize(60, 40));
	eight = new wxButton(this, wxID_ANY, "8", wxPoint(70, 140), wxSize(60, 40));
	nine = new wxButton(this, wxID_ANY, "9", wxPoint(130, 140), wxSize(60, 40));
